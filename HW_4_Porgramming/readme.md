...
* Due date and time: December 4 (Sunday), 23:59 ET

* Carmen submission: 
Submit a .zip file named `HW4_programming_name_number.zip` (e.g., HW4_programming_chang_101.zip), which contains
...
* Download the data `Starplus.npz` from Carmen (which is under `Files/Homework/HW4`) and put it in the same folder as `Linear_Classifiers.py`
...
* Please follow **Submission instructions** to submit a .zip file named HW4_programming_name_number.zip (e.g., HW4_programming_chang_101.zip), which contains the above three files.
